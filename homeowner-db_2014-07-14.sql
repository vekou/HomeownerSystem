...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Jul 14, 2014 at 08:23 AM
...
-- Last update: Jul 14, 2014 at 06:39 AM
--
...
(1, 'Delas Alas', 'Jay', 'Bagasbas', '09478929659', 'jay_delasalas@ymail.com', 1, '2014-06-28 13:19:31', 1, 0, 0),
(2, 'Garcia', 'Mark Denrich', 'Deocales', '091738363937', 'adfadjfkjdf@df', 1, '2014-06-28 14:02:25', 1, 0, 0),
(3, 'Veloro', 'Riechelle', 'Naval', '0909809809', 'sdfs@df', 1, '2014-06-29 03:19:22', 1, 0, 0),
(4, 'Maas', 'Joed', 'Marquez', '39839489384', 'df@dfd', 1, '2014-06-29 03:19:35', 1, 0, 0),
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Ledger Details' AUTO_INCREMENT=22 ;
...
INSERT INTO `ledgeritem` (`id`, `amount`, `lot`, `startdate`, `enddate`, `desc`, `remarks`) VALUES
...
(9, 1600, 4, '2014-07-01', '2014-07-31', 'P1L3B1-54545', ''),
(10, 1600, 4, '2014-06-01', '2014-06-30', 'P1L3B1-54545', ''),
...
--
-- Creation: Jul 13, 2014 at 10:24 PM
-- Last update: Jul 13, 2014 at 10:24 PM
--
...
INSERT INTO `settings` (`id`, `subdname`, `brgy`, `city`, `province`, `zipcode`, `contactno`, `email`, `price`, `interest`, `intgraceperiod`) VALUES
(1, 'Santa Isabel Village', 'Isabang', 'Lucena City', 'Quezon', '4301', '', '', 4, '0.1000', 3);
...
--
ALTER TABLE `ledger`
MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Ledger ID',AUTO_INCREMENT=22;
--
